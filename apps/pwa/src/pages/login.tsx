  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center px-6 gap-10">
      ...
      <div className="text-center rise-in">
        ...
        <h1 className="display-title text-5xl font-bold mb-3 text-foreground">Manna</h1>
        <p className="text-sm text-muted-foreground">感動・洞察・感想をコミュニティで共有しよう</p>
      </div>
      ...
      >
        ...
        >
          ...
          <svg width="18" height="18" viewBox="0 0 48 48" aria-hidden="true">
            <path
              fill="#EA4335"
              d="M24 9.5c3.5 0 6.6 1.2 9 3.2l6.7-6.7C35.7 2.4 30.2 0 24 0 14.7 0 6.8 5.4 2.9 13.3l7.8 6C12.5 13.4 17.9 9.5 24 9.5z"
            />
            <path
              fill="#4285F4"
            ...
            <path
              fill="#FBBC05"
              d="M10.7 28.7A14.5 14.5 0 0 1 9.5 24c0-1.6.3-3.2.8-4.7l-7.8-6A23.9 23.9 0 0 0 0 24c0 3.9.9 7.5 2.6 10.7l8.1-6z"
            />
            <path
              fill="#34A853"
