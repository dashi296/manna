    ...
    <div className={`${VERSE_MARKER_WIDTH} shrink-0 self-stretch pt-3`} aria-hidden="true">
      <div className="relative flex w-fit items-center select-none">
        ...
        {entry.anchoredCount >= 2 && (
          ...
          // それより前に出さないとバッジが下に潜る
          <span
            className="absolute -top-1 -right-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-lagoon px-1 text-[10px] leading-none font-medium text-foreground"
