...
describe('isValidCursor', () => {
  it('PostgREST が返す timestamptz を受け付ける', () => {
    ...
    expect(isValidCursor({ createdAt: '2026-07-25T10:00:00.123456+00:00', id: VALID_UUID })).toBe(
      true,
    )
  ...
  it('フィルタ式を壊す文字を含む値を弾く', () => {
    ...
    expect(
      isValidCursor({ createdAt: '2026-07-25T10:00:00+00:00,or(1.eq.1)', id: VALID_UUID }),
    ).toBe(false)
    expect(isValidCursor({ createdAt: '2026-07-25T10:00:00+00:00', id: `${VALID_UUID}"` })).toBe(
      false,
    )
  })
